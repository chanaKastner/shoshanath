...
const Carousel = ({
	...
	leftTriangleColor = '#824c4ddb',
	leftIcon,
	rightTriangleColor = '#824c4ddb',
	rightIcon,
	slides = [],
}) => {
...
const slides = [
	{
		...
		image: "/זרי ארוסין/זרים חיים/בשילוב רקפת.jpg",

	},
	{
		// title: 'Second title',
		// subtitle: 'Second subtitle',
		image: "/זרי כלה/זרי כלה ליד/ורדים בכתר 1.JPG",

	},
	{
		// title: 'Third title',
		// subtitle: 'Third subtitle',
		image: "/סידורי פרחים/עיצובי פרחים/כדור קלאסי 5.jpg",
